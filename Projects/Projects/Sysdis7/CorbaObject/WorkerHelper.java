...
//
final public class WorkerHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Worker val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Worker");
        }
    ...
    id()
    {
        return "IDL:CorbaObject/Worker:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, Worker val)
    {
